...
//   print out the index of the column/row which contains the Screen saver
                ...
                //Get the checkbox ->table[@class='SampleTable']/tbody/tr[2]/td[1]
                //table[@class='SampleTable']/tbody/tr[4]/td[1]
// row strart with one, loop start with zero that is why we are adding 1 tome make the loop and the row to be synchronized with each other
